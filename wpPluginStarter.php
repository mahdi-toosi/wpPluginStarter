...
final class Base_Plugin {
    ...
    public function define_constants() {
        ...
        define( 'WP_PLUGIN_STARTER_PATH', dirname( WP_PLUGIN_STARTER_FILE ) );
        define( 'WP_PLUGIN_STARTER_INCLUDES', WP_PLUGIN_STARTER_PATH . '/includes' );
    ...
    public function activate() {
        ...
        update_option( 'baseplugin_version', WP_PLUGIN_STARTER_VERSION );
    }
    ...
    public function includes() {
        ...
        require_once WP_PLUGIN_STARTER_INCLUDES . '/Assets.php';

        if ( $this->is_request( 'admin' ) ) {
            require_once WP_PLUGIN_STARTER_INCLUDES . '/Admin.php';
        }

        if ( $this->is_request( 'frontend' ) ) {
            require_once WP_PLUGIN_STARTER_INCLUDES . '/Frontend.php';
        }

        if ( $this->is_request( 'ajax' ) ) {
            // require_once WP_PLUGIN_STARTER_INCLUDES . '/class-ajax.php';
        }

        require_once WP_PLUGIN_STARTER_INCLUDES . '/Api.php';
    }
...
$starterPlugin = Base_Plugin::init();
